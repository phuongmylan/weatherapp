...
@hover-bg-stcolor: #2f4651;
@hover-bg-endcolor: #133a4c;
@hover-gradient-color: #2f4651, #133a4c;
@hover-border-color: #777777;
@hover-font-color: #dddddd;
@hover-icon-color: #cccccc;

@active-bg-stcolor: #74c3e7;
@active-bg-endcolor: #179bd7;
@active-gradient-color: #74c3e7, #179bd7;
...
@grid-focusout: desaturate( @active-bg-endcolor, 80% );
...
@gantt-row-selection-bg-color: #179bd7;
...
@sp-outline:transparent none 0px; @sp-item-hover-color:rgba(60, 146, 169, 0.40); @sp-noborder:0px solid transparent; @sp-header-font-size:14px; @sp-header-border-radius:0px;
/*-----------------------Diagram Definition-----------------*/
...
@ssheader-select-bgcolor: darken( saturate( @hover-bg-stcolor, 54% ), 11% );
@ssheader-hover-bordercolor:@hover-border-color;
@sscontent-border-color:@content-border-color;
@ssfroze-highlight-color: darken( desaturate( @active-bg-stcolor, 2% ), 23% );
@sschart-darktheme-bgcolor: darken( @content-font-color, 13% );
@ssdrpdwnbrdr: darken( @header-border-color, 7% );
@ssselectall: lighten( saturate( @active-bg-stcolor, 8% ), 19% );
