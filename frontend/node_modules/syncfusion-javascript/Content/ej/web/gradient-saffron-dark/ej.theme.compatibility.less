...
@hover-bg-stcolor: #57452d;
@hover-bg-endcolor: #57380f;
@hover-gradient-color: #57452d, #57380f;
...
@ssheader-select-bgcolor:darken( saturate( @hover-bg-stcolor, 59% ), 13% );
