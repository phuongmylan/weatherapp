...
@hover-bg-stcolor:#1010af;
@hover-bg-endcolor:#1010af;
@hover-gradient-color:none;
@hover-border-color:#ffffff;
@hover-font-color:#ffffff;
@hover-icon-color:#ffffff;

@active-bg-stcolor:#0000FF;
@active-bg-endcolor:#0000FF;
...
@gantt-chart-manual-child-progressbar-stbg-color: #73F8E2;
@gantt-chart-manual-child-progressbar-endbg-color: #73F8E2;
@gantt-chart-manual-child-progressbar-gradient-color:none;
@gantt-chart-manual-child-taskbar-color: #3FB9A5;
@gantt-chart-manual-child-taskbar-border-color: #73F8E2;
...
@rd-accordion-tile-hover:#1900FF;
.rd-hover-gradient() {
    .custom-gradient(@hover-gradient-color, @hover-bg-stcolor, @hover-bg-endcolor, 0%, 0% );
}
/*----------------------Reportdesigner Definition End------------------*/
/*-----------------------SymbolPalette Definition-----------------*/
@sp-outline:transparent none 0px; @sp-item-hover-color:#1010af; @sp-noborder:0px solid transparent; @sp-header-font-size:14px; @sp-header-border-radius:0px;
/*-----------------------Diagram Definition-----------------*/
...
@ssheader-select-bgcolor: darken( saturate( @hover-bg-stcolor, 17% ), 7% );
