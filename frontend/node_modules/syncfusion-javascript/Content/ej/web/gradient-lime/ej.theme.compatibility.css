...
.e-js.e-grid .e-cloneproperties {
  background: #e7f1c9;
  /* Old browsers */
  background: -moz-linear-gradient(top, #e7f1c9, #d3e59b);
  /* FF3.6+ */
  background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #e7f1c9), color-stop(100%, #d3e59b));
  /* Chrome,Safari4+ */
  background: -webkit-linear-gradient(top, #e7f1c9, #d3e59b);
  /* Chrome10+,Safari5.1+ */
  background: -o-linear-gradient(top, #e7f1c9, #d3e59b);
  /* Opera 11.10+ */
  background: -ms-linear-gradient(top, #e7f1c9, #d3e59b);
  /* IE10+ */
  background: linear-gradient(to bottom, #e7f1c9, #d3e59b);
  /* W3C */
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#e7f1c9', endColorstr='#d3e59b', GradientType=0);
  /* IE6-9 */
...
.e-js.e-grid td.e-cellselectionbackground {
  background: #cee292;
  /* Old browsers */
  background: -moz-linear-gradient(top, #cee292, #94b530);
  /* FF3.6+ */
  background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #cee292), color-stop(100%, #94b530));
  /* Chrome,Safari4+ */
  background: -webkit-linear-gradient(top, #cee292, #94b530);
  /* Chrome10+,Safari5.1+ */
  background: -o-linear-gradient(top, #cee292, #94b530);
  /* Opera 11.10+ */
  background: -ms-linear-gradient(top, #cee292, #94b530);
  /* IE10+ */
  background: linear-gradient(to bottom, #cee292, #94b530);
  /* W3C */
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#cee292', endColorstr='#94b530', GradientType=0);
  /* IE6-9 */
...
.e-js.e-grid.e-responsive .e-rowcell {
  border-bottom-color: rgba(187, 188, 187, 0.5);
}
...
.e-js.e-schedule .e-commonviewbutton {
  ...
  /* Opera 11.10+ */
  background: -ms-linear-gradient(top, whitesmoke, #dddddd);
  /* IE10+ */
...
.e-js.e-schedule .e-mousehover {
  background-color: #d5e7a1 !important;
  color: #282827;
}
...
@media print {
  ...
  .e-js.e-schedule .e-scheduleheader {
    ...
    /* Old browsers */
    background: -moz-linear-gradient(top, whitesmoke, #dddddd !important) !important;
    /* FF3.6+ */
    background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, whitesmoke), color-stop(100%, #dddddd)) !important;
    /* Chrome,Safari4+ */
    background: -webkit-linear-gradient(top, whitesmoke, #dddddd !important) !important;
    /* Chrome10+,Safari5.1+ */
    background: -o-linear-gradient(top, whitesmoke, #dddddd !important) !important;
    /* Opera 11.10+ */
    background: -ms-linear-gradient(top, whitesmoke, #dddddd !important) !important;
    /* IE10+ */
    background: linear-gradient(to bottom, whitesmoke, #dddddd !important) !important;
    /* W3C */
...
.e-widget.e-fileexplorer .e-gridcontent .e-fe-selection-rect {
  ...
  background-color: rgba(206, 226, 146, 0.2);
}
.e-widget.e-fileexplorer .e-tile-wrapper .e-fe-selection-rect,
.e-widget.e-fileexplorer .e-gridcontent .e-fe-selection-rect {
...
.e-widget.e-menu.e-horizontal > .e-list.e-active > span.e-menu-arrow > span.e-arrowMenuOuter {
  ...
  left: 0px;
  top: 0px;
  border-bottom: 10px solid #e7f1c9;
  position: absolute;
}
...
.e-js.e-pivotgrid .e-hoverCell {
  background-color: #e7f1c9 !important;
}
...
.e-cellSelection {
  background: linear-gradient(to bottom, #e7f1c9 0%, #d3e59b 100%);
...
.e-js.e-pivotschemadesigner .e-removePivotBtn:hover {
  cursor: pointer;
  background: none repeat scroll 0 0 linear-gradient(to bottom, #e7f1c9 0%, #d3e59b 100%);
}
...
.e-js.e-pivotclient .e-reportli:hover {
  background: linear-gradient(to bottom, whitesmoke 0%, #dddddd 100%) !important;
  border: none !important;
...
.e-widget.e-kanban .e-kanbancontent .e-rowcell .e-targetclone {
  background: #e7f1c9;
  /* Old browsers */
  background: -moz-linear-gradient(top, white, #d3e59b);
  /* FF3.6+ */
  background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #e7f1c9), color-stop(100%, #d3e59b));
  /* Chrome,Safari4+ */
  background: -webkit-linear-gradient(top, white, #d3e59b);
  /* Chrome10+,Safari5.1+ */
  background: -o-linear-gradient(top, white, #d3e59b);
  /* Opera 11.10+ */
  background: -ms-linear-gradient(top, white, #d3e59b);
  /* IE10+ */
  background: linear-gradient(to bottom, white, #d3e59b);
  /* W3C */
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#e7f1c9', endColorstr='#d3e59b', GradientType=0);
  /* IE6-9 */
...
.e-js.e-ganttchart .e-gantt-parenttaskbar-progress {
  ...
  /* FF3.6+ */
  background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #333333), color-stop(100%, #cccccc));
  /* Chrome,Safari4+ */
...
.e-widget .e-dropdownbase .e-list-item {
  ...
  background-color: white;
  border-bottom: 1px;
  border-color: whitesmoke, #dddddd;
  color: #333333;
  font-family: Segoe UI, Helvetica Neue, Ubuntu, Arial;
  font-size: 14px;
  line-height: 2.4em;
