...
@hover-bg-stcolor: #e7f1c9;
@hover-bg-endcolor: #d3e59b;
@hover-gradient-color: #e7f1c9, #d3e59b;
...
@shadow-bg-color: darken( @default-bg-stcolor, 16% );
...
@ssheader-select-bgcolor: lighten( saturate(@active-bg-stcolor, 1% ), 21% );
