...
@hover-bg-stcolor: #c5e6f5;
@hover-bg-endcolor: #96d2ed;
@hover-gradient-color: #c5e6f5, #96d2ed;
...
@ssheader-select-bgcolor: lighten( desaturate( @hover-bg-stcolor, 16% ), 5% );
