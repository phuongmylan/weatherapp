@skin: "gradient-lime-dark";
@font-family: Segoe UI,Helvetica Neue,Ubuntu,Arial;
@font-size: 12px;
@border-size: 1px;
@border-type: solid;
@tools-border-radius: 3px;
@widget-bg-color:#111111;
@label-color:#ffffff;

@header-bg-stcolor: #363636;
@header-bg-endcolor: #000000;
@header-gradient-color: #363636, #000000;
@header-border-color: #494949;
@header-font-color: #dddddd;
@header-icon-color: #cccccc;
@filtermenu-color: #494949;

@tooltip-line-height : 18px;

@content-bg-color: #000000;
@content-border-color: #494949;
@content-font-color: #dddddd;

@disable-control-background-color: #1d1d1d;
@disable-control-border-color: #333333;
@disable-icon-bg-color: #525252;

@default-bg-stcolor: #4d4d4d;
@default-bg-endcolor: #212121;
@default-gradient-color: #4d4d4d, #212121;
@default-border-color: #777777;
@default-font-color: #dddddd;
@default-icon-color: #cccccc;

@hover-bg-stcolor: #4a5038;
@hover-bg-endcolor: #404a22;
@hover-gradient-color: #4a5038, #404a22;
@hover-border-color: #777777;
@hover-font-color: #dddddd;
@hover-icon-color: #cccccc;

@active-bg-stcolor: #cee292;
@active-bg-endcolor: #aecf49;
@active-gradient-color: #cee292, #aecf49;
@active-border-color: #494949;
...
@hover-bg-mdcolor: #92ae3a;

@scroll-bg-color: lighten(@content-bg-color, 15%);
@scroll-handle-color: lighten( @content-bg-color, 25% );
...
@gedit-title-color: lighten(@content-bg-color, 21%);

@gtouch-border-color: #FFFFFF;
...
@gcaption-border-color: darken( @default-bg-stcolor, 12%);
...
@row-border-coloropac: rgba(48,48,48,0.5);
...
@cell-selection-endbg-color: darken( @active-bg-endcolor, 20%);
@column-selection-bg-color: @default-bg-stcolor;
@alt-row-bg-color: lighten( @content-bg-color, 7%);
...
@filter-input-border-color: #424242;
@filter-input-bg-color: #3a3a3a;

@alternate-border-color: #242424;
@timeline-bg-color: #778F31;


@captcha-refresh-border: 1px solid lighten( @default-border-color, 50% );
@captcha-image-border: 1px solid lighten( @default-border-color, 10% );
@captcha-valid-border: 1px solid lighten( saturate( @default-border-color, 2% ), 49% );
@captcha-image: #f7f7f7;

@watermark-font-style: italic;
@watermark-font-color: darken( @default-font-color, 71% );
...
@shadow-bg-color: lighten( @default-bg-stcolor, 37% );
...
@schedule-cells-bg-color: lighten( @content-bg-color, 7%);

@grid-uisupport-background-color: #58585B;
@grid-uisupport-number-color: #1E1F1E;
@grid-focusout: desaturate( @active-bg-endcolor, 58% );
...
@gantt-altRow-bg-color: lighten(@content-bg-color, 7%);
...
@gantt-row-selection-bg-color: #aecf49;
...
@gantt-parent-progress-enbg-color: darken(@content-font-color, 60%);
...
@gantt-taskbar-selection-border-color: #FFFFFF;
...
@treegrid-detailicon-shadow-color: lighten(@content-bg-color,11%);
...
@treegrid-summaryrow-backgroundcolor: darken( @default-bg-stcolor, 12%);
@treegrid-totalsummaryrow-backgroundcolor: darken( @default-bg-stcolor, 12%);
...
@colorpicker-image: url(../common-images/darktheme/colorpicker_dark.png);
...
@colorpicker-hover-font-color: #fff;

@default-ui-icon: url(../common-images/icons-halfwhite.png);
...
@active-grid-image: url(../common-images/icons-halfwhite.png);

@checkedtick-image: url(images/checkedtick.png);
@tab-background-color: #1e1e1e;
@tab-background-color-dark: #1e1e1e;
...
.cell-selection() {
    .custom-gradient(@active-gradient-color, @cell-selection-stbg-color, @cell-selection-endbg-color, 0%, 20%);
}
...
.hover-gradientfunction() {
    background: @tab-background-color-dark; /* Old browsers */
}
...
@map-home: url(../common-images/maps/Home_lime.png);
@map-home-hover: url(../common-images/maps/Home_hover_lime.png);

/*-----------------------PdfViewer------------------*/
@pdfviewer-scrollcontainer:lighten(@content-bg-color,15%);
...
.scrollPane-setcolor() {
    background-color: darken( @default-icon-color, 62 );
}

.scrollThumb-setcolor() {
    background-color: darken( @default-icon-color, 35 );
}
...
.scrollThumb-hovercolor() {
    background-color: darken( @default-icon-color, 19 );
}
...
@rv-pageviewcontainer-bg-color: lighten(@content-bg-color, 24%); 
@rv-documentMappopup-bg-color:#111111 !important; 
...
@rd-exp-set:@active-bg-stcolor;
@rd-exp-border:#c8c8c8;
@rd-exp-reset:#000000;
@rd-list-bgreset:transparent;
@rd-surfacecontainer-bg-color:  lighten(@content-bg-color, 24%);
@rd-switch-bg-color: @content-bg-color;
@rd-accordion-hover:#6d6d6d,#3a3a3a;
@rd-accordion-border:@hover-border-color;
@rd-tab-fontcolor:#cccccc;
@rd-tab-hover-fontcolor:#dddddd;
@rd-dialog-addBtn:@active-bg-stcolor;
@rd-accordion-tile-hover:#535353,#3a3a3a;
.rd-tile-hover-gradient(){
    .custom-gradient(@rd-accordion-tile-hover, #535353,#3a3a3a, 0%, 0% );
}
.rd-hover-gradient() {
    .custom-gradient(@rd-accordion-hover,#6d6d6d, #3a3a3a, 0%, 0% );
}
/*----------------------Reportdesigner Definition End------------------*/
/*-----------------------SymbolPalette Definition-----------------*/
@sp-outline:transparent none 0px; @sp-item-hover-color: rgba(181, 213, 83, 0.40); @sp-noborder:0px solid transparent; @sp-header-font-size:14px; @sp-header-border-radius:0px;
/*-----------------------Diagram Definition-----------------*/
@dg-contextmenu:url("../common-images/diagram/diagram_context1.png");@dg-contextmenu-hover:url("../common-images/diagram/diagram_context1.png");
@dg-ruler-overlap-bg: #212121;
@dg-ruler-space-bg: #4d4d4d;
@dg-ruler-tick: #cccccc;
@dg-ruler-label: #dddddd;

/*-----------------------Datepicker Definition-----------------*/
@disable-datepicker-text: darken( @default-font-color, 46% );
/*-----------------------Bootstrap support-----------------*/
@bs-default-bg-stcolor:@default-bg-stcolor; @bs-header-bg-stcolor:@header-bg-stcolor; @bs-shadow-bg-color:@shadow-bg-color; @bs-content-font-color:@content-font-color; @bs-header-font-color:@header-font-color; @bs-hover-font-color:@hover-font-color; @bs-active-font-color:@active-font-color; @shadow-bg-size:2px; @content-font-color-element:#FFFFFF; .bs-default-gradient() {
    .default-gradient();
}
...
@rbngallery-disable-color:#4F4F4F;
...
@rbnhover-font-color: #FFFFFF;
.ribbon-toggle-gradient(){
 .custom-gradient(@active-gradient-color, @rbntoggle-start-color, @rbntoggle-end-color, 15%, 0%);
}
...
.mouseselection-stylefor-fileexplorer() {
    background-color: fade(@active-bg-stcolor,30%);
}
/*----------------------File Explorer End-----------------------*/
/*----------------------Kanban Definition-----------------------*/
@kanban-cell-exceed: darken( #f8d9c7, 68% );
@kanban-cell-deceed: darken( #ffedcd, 70% );
@kanban-cell-border:darken(@default-border-color,29%);
@kanban-card-border:darken(@content-border-color,25%);
@kanban-select-cardhead-border:darken(@default-border-color, 28%);
@kanban-cardhead-border:darken(@default-border-color, 28%);
@kanban-toolbar-border:darken(@default-border-color,25%);
...
@ssheader-select-bgcolor: darken( saturate( @hover-bg-stcolor, 31% ), 13% );
...
@ssfroze-highlight-color: darken( desaturate( @active-bg-stcolor, 10% ), 20% );
@sschart-darktheme-bgcolor: darken( @content-font-color, 13% );
@ssdrpdwnbrdr: darken( @header-border-color, 7% );
@ssselectall: lighten(@active-bg-stcolor, 12%);
@ssselectallhover: lighten(@active-bg-stcolor, 2%);
@ssselectselected: darken( desaturate( @active-bg-stcolor, 17% ), 4% );
...
@ss-chartmenu-bgcolor:lighten( @default-bg-endcolor, 1% );
...
.spread-toggle-gradient(){
  .custom-gradient(@active-gradient-color,@ssbtntgle-start-color, @ssbtntgle-end-color, 15%, 0%);
}
@ssactive-font-color:@active-font-color;
@ssactive-icon-color:@active-icon-color;
@ssdown-arrow-cursor:url("../common-images/spreadsheet/down_arrow_dark.cur"),auto;
@ssright-arrow-cursor:url("../common-images/spreadsheet/right_arrow_dark.cur"),auto;
@ssformatpainter-cursor:url("../common-images/spreadsheet/format_painter_dark.cur"),auto;
@ssdraw-border-cursor:url("../common-images/spreadsheet/draw_border_dark.cur"),auto;
@ssdraw-border-grid-cursor:url("../common-images/spreadsheet/draw_border_grid_dark.cur"),auto;
/*----------------------Spreadsheet End-----------------------*/
/*----------------------Office 365 theme-----------------------*/
.border-selection(){}
...
/*-----------------------HeatMap Definition-----------------*/
@hmp-border-color: #808080;
@hmp-font-color: #FFFFFF;
@hmp-background-color: #000000;
/* Common style */
