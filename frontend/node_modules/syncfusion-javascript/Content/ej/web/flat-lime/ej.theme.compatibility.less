...
@hover-bg-stcolor: #cee292;
@hover-bg-endcolor: #cee292;
...
@row-border-color: @hover-bg-stcolor;
...
@watermark-font-color: lighten( saturate( spin( #333333, 240deg ), 1% ), 62% );
...
@gantt-altRow-bg-color: darken(@content-bg-color,3%);
...
@dg-ruler-overlap-bg: #ececec;
@dg-ruler-space-bg: #ececec;
...
@kanban-select-cardhead-border:lighten(@default-border-color,7%);
...
@ssheader-select-bgcolor:lighten( saturate(@hover-bg-stcolor, 1%), 21%);
...
@ss-chartmenu-bgcolor:lighten( @default-bg-stcolor, 7% );
...
.daterange-inrange-background() {
    background:negation(@default-bg-stcolor, #080808);
   }
/*---------------- Office-365 ----------------*/
