...
@hover-bg-stcolor: #082e40;
@hover-bg-endcolor: #082e40;
...
@cell-selection-stbg-color: darken( desaturate( spin( @active-bg-stcolor, -1deg ), 15% ), 11% );
@cell-selection-endbg-color: darken( desaturate( spin( @active-bg-stcolor, -1deg ), 15% ), 11% );
...
@rd-tab-fontcolor:#aaaaaa;
@rd-tab-hover-fontcolor:#cccccc;
...
@sp-outline:transparent none 0px; @sp-item-hover-color:rgba(35, 130, 195, 0.40); @sp-noborder:0px solid transparent; @sp-header-font-size:14px; @sp-header-border-radius:0px;
/*-----------------------Diagram Definition-----------------*/
...
@ssheader-select-bgcolor: darken( @active-bg-stcolor, 33% );
