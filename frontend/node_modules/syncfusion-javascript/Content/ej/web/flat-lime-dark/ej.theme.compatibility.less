...
@hover-bg-stcolor: #343e16;
@hover-bg-endcolor: #343e16;
@hover-gradient-color: none;
@hover-border-color: #494949;
@hover-font-color: #aaaaaa;
@hover-icon-color: #efefef;

@active-bg-stcolor: #aecf49;
...
@gcaption-border-color: lighten(@default-bg-stcolor, 5%);
...
@cell-selection-stbg-color: darken( desaturate( spin( @active-bg-stcolor, -4deg ), 16% ), 19% );
@cell-selection-endbg-color: darken( desaturate( spin( @active-bg-stcolor, -4deg ), 16% ), 19% );
...
@shadow-bg-color: lighten( @default-bg-stcolor, 54% );
...
@grid-focusout: desaturate( @active-bg-stcolor, 58% );
...
@gantt-dialog-close-icon-mouseover-color: lighten(@content-bg-color,10%);
...
@rd-accordion-hover:none;
@rd-accordion-border:@hover-border-color;
@rd-tab-fontcolor:#cccccc;
@rd-tab-hover-fontcolor:#aaaaaa;
@rd-dialog-addBtn:@active-bg-stcolor;
@rd-accordion-tile-hover:none;
.rd-tile-hover-gradient(){
    .custom-gradient(@rd-accordion-tile-hover, #3a3a3a,#3a3a3a, 0%, 0% );
}
.rd-hover-gradient() {
    .custom-gradient(@rd-accordion-hover,#3a3a3a,#3b3b3b, 0%, 0% );
}
/*----------------------Reportdesigner Definition End------------------*/
/*-----------------------SymbolPalette Definition-----------------*/
@sp-outline:transparent none 0px; @sp-item-hover-color:rgba(169, 202, 68, 0.40); @sp-noborder:0px solid transparent; @sp-header-font-size:14px; @sp-header-border-radius:0px;
/*-----------------------Diagram Definition-----------------*/
...
@rbntoggle-end-color:lighten(@active-bg-endcolor, 10%);
...
@kanban-cell-border:darken(@default-border-color,25%);
...
@ssheader-select-bgcolor: darken(saturate(@hover-bg-stcolor,1%), 2%);
...
@ssselectall: lighten(@active-bg-stcolor, 30%);
...
@ssbtntgle-end-color:lighten(@active-bg-stcolor, 10%);
@ss-chartmenu-bgcolor:lighten( @default-bg-stcolor, 1% );
...
.daterange-inrange-background() {
    background:negation(@default-bg-stcolor, #212121);
    }
/*---------------- Office-365 ----------------*/
